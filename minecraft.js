function play() {
  addhtml("<iframe src='https://classic.minecraft.net/?sessionid=53a4aee3f6beea3b126395fac1212b32&deploytool=vercel-java' id='game'></iframe><div id='X' style='color: red; position:absolute; right:0; top:0; font-weight: bold; font-size: 70px;z-index: 2;cursor: pointer;' onclick='stop();'>x</div><div onclick='stop();' style='position:fixed; top:0; left:0; text-align:center; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:1.5; color:white; background-color:black; font-size:165%;' id='loading'>Đang tải,vui lòng chờ trong giây lát!</div>");
}
